...
Asinstar= Matrix([[m1/12*b**2, 0, 0],  [0, m1/12*b**2, 0],  [0, 0, 0]])

Astarzero =  Matrix([[m1/12*b**2, 0, 0],  [0, m1/12*b**2, m1*b/2*b],  [0, m1*b/2*b, m1*b**2]])
...
iyy= m1/3*b^2 + m3/3*b^2
izz= m2/12 * b^2  + m1/12*b^2


# In[ ]:


I_matrix_of_S_about_O = Matrix([i11,])
